        ...
        <div>
            ...
            <div className='w-[70%]'>
                ...
                <div className=' my-4 md:max-w-full'>
                    <div className='flex flex-col checkout-form p-4' >
                        <label>country:</label>
                        ...
                        <div className=' flex justify-between w-full mt-9 '>
                            ...
                            <input type="button" disabled={enabled} value="Continue" className={` text-white p-3 rounded-md
                                 ${isCompleted ? " bg-blue-800" : "bg-gray-500"}`} onClick={() => {
                                    dispatch({ type: 'ADD_SHIPPING', payload: information })
                                    return router.replace('/checkout/payment')
                                }} />
                        </div>
                    </div>
                </div>
